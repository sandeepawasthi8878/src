  ...
  return (
    <>
      ...
      <Carousel showArrows={true} showThumbs={false} infiniteLoop={true} autoPlay={true} interval={2000}>
        ...
        <div>
          <img src="https://images.unsplash.com/photo-1456086272160-b28b0645b729?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8YXJ0c3xlbnwwfHwwfHx8MA%3D%3D" />
        </div>
        <div>
          <img src="https://plus.unsplash.com/premium_photo-1673467010928-6a69e1ef267a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8YXJ0c3xlbnwwfHwwfHx8MA%3D%3D" />
        </div>
      </Carousel>
